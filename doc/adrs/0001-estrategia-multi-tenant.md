...
------------------------------------------------------------
erDiagram
CONDOMINIO ||--o{ USUARIO : "tem"
CONDOMINIO ||--o{ APARTAMENTO : "tem"
CONDOMINIO ||--o{ FATURA : "filtra (tenant_id)"

    USUARIO ||--o{ APARTAMENTO : "é titular de"
    APARTAMENTO ||--o{ FATURA : "gera"
